...
from my_balance import yaw, go_yaw_time, go_yaw_rot, diving, diving_while, go_yaw_simulator
...
def test(set_speed, set_time):
    ...
    print "go_yaw"
    led_green()
    go_yaw_time(set_speed, 0, set_time)
    ...
    print "go_yaw"
    led_green()
    go_yaw_time(set_speed-2, 100, set_time)
